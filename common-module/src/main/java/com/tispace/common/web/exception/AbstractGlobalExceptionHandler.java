package com.tispace.common.web.exception;
...
public abstract class AbstractGlobalExceptionHandler {
    ...
    protected static final String ERROR_CODE_EXTERNAL_API_ERROR = "EXTERNAL_API_ERROR";
    protected static final String ERROR_CODE_CONNECTION_ERROR = "CONNECTION_ERROR";
    protected static final String ERROR_CODE_SERIALIZATION_ERROR = "SERIALIZATION_ERROR";
    protected static final String ERROR_CODE_CACHE_UNAVAILABLE = "CACHE_UNAVAILABLE";
    protected static final String ERROR_CODE_RATE_LIMIT_EXCEEDED = "RATE_LIMIT_EXCEEDED";
    protected static final String ERROR_CODE_BUSINESS_ERROR = "BUSINESS_ERROR";
    protected static final String ERROR_CODE_VALIDATION_ERROR = "VALIDATION_ERROR";
    protected static final String ERROR_CODE_INVALID_ARGUMENT = "INVALID_ARGUMENT";
    protected static final String ERROR_CODE_INTERNAL_ERROR = "INTERNAL_ERROR";
    ...
    protected static final String ERROR_CODE_BAD_REQUEST = "BAD_REQUEST";
    ...
    protected ResponseEntity<ErrorResponseDTO> buildErrorResponse(String errorCode, String message,
